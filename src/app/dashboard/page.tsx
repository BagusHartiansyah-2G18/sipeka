...
export default async function DashboardPage() {
  ...
  const isManagement = role === "KEPALA_BADAN" || role === "KABAG_UMUM_KEPEGAWAIAN" || role === "ADMIN";
          ...
          {isManagement ? (
            ...
            <>
              ...
              <div className="bg-white rounded-lg border border-gray-200 p-6 hover:shadow-md transition-shadow">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-gray-600 text-sm font-medium">Status Pengajuan</p>
                    <p className="text-2xl font-bold text-yellow-600 mt-2">1</p>
                    <p className="text-gray-500 text-xs mt-1">Sedang diproses</p>
                  </div>
              ...
              <div className="bg-white rounded-lg border border-gray-200 p-6 hover:shadow-md transition-shadow">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-lg font-bold text-gray-900 mt-2">Oct 2025</p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 bg-white rounded-lg border border-gray-200 p-6">
            ...
            <div className="space-y-3">
              {(isManagement ? [
                { name: "Budi Santoso", type: "Cuti Tahunan", date: "2 hari lalu", status: "Menunggu" },
                { name: "Siti Nurhaliza", type: "KGB", date: "4 hari lalu", status: "Menunggu" },
                ...
                { name: "KGB", type: "Kenaikan Gaji Berkala", date: "1 bulan lalu", status: "Disetujui" },
              ]).map((item, idx) => (
          ...
          <div className="bg-white rounded-lg border border-gray-200 p-6">
            ...
            <div className="space-y-2">
              ...
              <Link href="/dashboard/kgb" className="flex items-center justify-between p-3 bg-green-50 hover:bg-green-100 rounded-lg transition-colors text-green-600 font-medium text-sm">
                <span>Daftar KGB</span>
                <span>→</span>
              </Link>
              <Link href="/dashboard/pangkat" className="flex items-center justify-between p-3 bg-yellow-50 hover:bg-yellow-100 rounded-lg transition-colors text-yellow-600 font-medium text-sm">
